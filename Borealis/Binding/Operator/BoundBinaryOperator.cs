...
namespace Borealis.Binding {
    internal sealed class BoundBinaryOperator {
        ...
        public BoundBinaryOperator(SyntaxType syntaxType, BoundBinaryOperatorType operatorType, Type expressionType, Type resultType) : 
            this(syntaxType, operatorType, expressionType, expressionType, resultType) {
        }
        
        public BoundBinaryOperator(SyntaxType syntaxType, BoundBinaryOperatorType operatorType, Type leftExpressionType, Type rightExpressionType, Type resultType) {
        ...
        public static BoundBinaryOperator Bind(SyntaxType syntaxType, Type leftExpressionType, Type rightExpressionType) {
            return Operators.FirstOrDefault(boundOperator => 
                boundOperator.SyntaxType == syntaxType && 
                boundOperator.LeftExpressionType == leftExpressionType && 
