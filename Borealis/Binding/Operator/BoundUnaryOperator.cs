...
namespace Borealis.Binding {
    internal sealed class BoundUnaryOperator {
        ...
        public BoundUnaryOperator(SyntaxType syntaxType, BoundUnaryOperatorType operatorType, Type expressionType, Type resultType) {
        ...
        public static BoundUnaryOperator Bind(SyntaxType syntaxType, Type expressionType) {
            return Operators.FirstOrDefault(boundOperator => boundOperator.SyntaxType == syntaxType && boundOperator.ExpressionType == expressionType);
        }
    }
}